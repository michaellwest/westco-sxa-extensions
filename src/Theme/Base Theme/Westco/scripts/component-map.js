XA.component.map = (function ($, document) {
    ...
    //TODO: this have to be removed from here as this existist also in component-search-query.js
    ...
    MapView = Backbone.View.extend({
        ...
        renderDynamicPois: function() {
            ...
            for (i = 0; i < dynamicPoiList.length; i++) {
                mapsConnector.renderDynamicPoi(id, dynamicPoiList[i], this.getPoiContent.bind(this));
            }
            ...
            switch (properties.centralPointMode) {
                case "Auto": {
                    if (properties.centralPoint !== "") {
                        callback.call(that, [properties.latidiute, properties.longitude]);
